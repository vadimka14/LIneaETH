...
from eth_async.data import config
from eth_async.classes import AutoRepr
from eth_async.blockscan_api import APIFunctions
...
class Networks:
    ...
    Scroll = Network(
        ...
        api=API(key=config.SCROLL_API_KEY, url='https://api.scrollscan.com/api', docs='https://docs.scrollscan.com/')
    )
